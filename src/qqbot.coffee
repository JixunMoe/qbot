...
class QQBot
    ...
    _on_message : (event)->
        ...
        # [Sun Feb 02 2014 16:33:50 GMT+0000 (GMT Standard Time)] DEBUG [群消息] [绅士仓库] 见崎樱:大大做一个A
        # I的time插件吧:3 Sun Feb 02 2014 16:33:49 GMT+0000 (GMT Standard Time)
        # console.log JSON.stringify @groupmember_info
        try
          if msg.type == 'group'
        ...
        @getQnum msg.from_uin, 1, (qqnum) ->
            msg.qnum = qqnum
            _that.dispatcher.dispatch(msg.content ,reply, _that, msg)
